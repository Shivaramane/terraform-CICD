...
resource "github_repository_file" "maintf" {
  ...
  branch              = "main"
  file                = "main.tf"
  content             = file("./deployments/mtc-dev/main.tf") #This will create a file named main.tf in the rep and the contents will be extracted from ths location
  commit_message      = "Managed by Terraform"
  overwrite_on_create = true
}

# this going to allow us to create OAuth information that we need to allow our TerraForm Cloud workspaceto authenticate with GitHub?
...
#This creates the mtc_workspace and links it to the OAuth token
...
#To allow our terraform runner to access aws
